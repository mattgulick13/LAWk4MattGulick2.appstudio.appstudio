...
const cacheName = 'LAWk4MattGulick_appstudio-2021-09-15 16:34:26.346796'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk4MattGulick_appstudio'.length) === 'LAWk4MattGulick_appstudio') {
